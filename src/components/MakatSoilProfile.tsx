...
export default function MakatSoilProfile() {
  ...
  // 1. РЕАЛЬНЫЕ ДАННЫЕ ИЗ ВАШИХ EXCEL ФАЙЛОВ (Теперь с переводами локаций)
      ...
      <div className="max-w-7xl mx-auto space-y-8 md:space-y-10 pb-16">
          ...
          <div className="relative z-10">
            ...
            <div className="flex flex-wrap gap-2 md:gap-4 text-xs sm:text-sm">
              <span className="flex items-center gap-2 bg-gray-100 px-3 py-2 md:px-4 md:py-2 rounded-lg text-textMain">
                <ThermometerSun size={18} className="text-warning shrink-0" /> {t('makat_tag_climate')}
              </span>
              <span className="flex items-center gap-2 bg-gray-100 px-3 py-2 md:px-4 md:py-2 rounded-lg text-textMain">
                <Droplets size={18} className="text-primary shrink-0" /> {t('makat_tag_water')}
              </span>
              <span className="flex items-center gap-2 bg-gray-100 px-3 py-2 md:px-4 md:py-2 rounded-lg text-textMain">
                <Layers size={18} className="text-danger shrink-0" /> {t('makat_tag_soil')}
              </span>
            </div>
          </div>
        </div>

        {/* БЛОК 2: Ключевые показатели */}
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 md:gap-6">
          <div className="bg-white rounded-2xl shadow-sm border border-borderFlat p-5 md:p-6">
            ...
            <h3 className="text-textMuted font-medium mb-1 text-sm md:text-base">{t('makat_metric1_title')}</h3>
            <div className="text-2xl md:text-3xl font-bold text-danger mb-2">9.0 <span className="text-sm md:text-lg font-normal text-textMuted">({t('makat_metric1_val_sub')})</span></div>
            <p className="text-xs md:text-sm text-textMuted">{t('makat_metric1_desc')}</p>
          </div>
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-borderFlat p-5 md:p-6">
            ...
            <h3 className="text-textMuted font-medium mb-1 text-sm md:text-base">{t('makat_metric2_title')}</h3>
            <div className="text-2xl md:text-3xl font-bold text-textMain mb-2">0.21%</div>
            <p className="text-xs md:text-sm text-textMuted">{t('makat_metric2_desc')}</p>
          </div>
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-borderFlat p-5 md:p-6 sm:col-span-2 md:col-span-1">
            ...
            <h3 className="text-textMuted font-medium mb-1 text-sm md:text-base">{t('makat_metric3_title')}</h3>
            <div className="text-2xl md:text-3xl font-bold text-textMain mb-2">{realSoilData.length} <span className="text-sm md:text-lg font-normal text-textMuted">{t('makat_metric3_val_sub')}</span></div>
            <p className="text-xs md:text-sm text-textMuted">{t('makat_metric3_desc')}</p>
          </div>
        </div>

        {/* БЛОК 3: Анализ по глубине */}
        <div className="bg-white rounded-2xl shadow-sm border border-borderFlat p-5 md:p-8">
          <h2 className="text-xl md:text-2xl font-bold text-textMain mb-4 md:mb-6">{t('makat_depth_title')}</h2>
          <div className="flex flex-col lg:flex-row gap-6 md:gap-10">
            <div className="flex-1 space-y-4">
              ...
              <ul className="space-y-4">
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    <strong className="block text-textMain text-sm md:text-base">{t('makat_horizon_a_title')}</strong>
                    <span className="text-xs md:text-sm text-textMuted">{t('makat_horizon_a_desc')}</span>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    <strong className="block text-textMain text-sm md:text-base">{t('makat_horizon_b_title')}</strong>
                    <span className="text-xs md:text-sm text-textMuted">{t('makat_horizon_b_desc')}</span>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    <strong className="block text-textMain text-sm md:text-base">{t('makat_horizon_c_title')}</strong>
                    <span className="text-xs md:text-sm text-textMuted">{t('makat_horizon_c_desc')}</span>
                  </div>
                </li>
              </ul>
            </div>
            ...
            <div className="w-full lg:w-64 flex flex-col rounded-xl overflow-hidden shadow-inner border border-borderFlat h-48 lg:h-80 shrink-0">
              <div className="h-[20%] bg-[#8B5A2B] flex items-center justify-center">
                <span className="text-white font-medium text-xs md:text-sm drop-shadow-md">{t('makat_chart_a')}</span>
              </div>
              <div className="h-[30%] bg-[#D2B48C] flex items-center justify-center border-t border-white/20">
                <span className="text-[#5C4033] font-medium text-xs md:text-sm">{t('makat_chart_b')}</span>
              </div>
              <div className="h-[50%] bg-[#F5DEB3] flex items-center justify-center border-t border-[#8B5A2B]/20">
                <span className="text-[#8B5A2B] font-medium text-xs md:text-sm">{t('makat_chart_c')}</span>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-borderFlat p-5 md:p-6">
            <div className="flex items-center justify-between mb-8">
              <div className="flex items-center gap-2">
                ...
                <h3 className="text-lg font-bold text-textMain">{t('chart_ph_title')}</h3>
              </div>
              <span className="text-xs font-bold text-red-500 bg-red-50 px-2 py-1 rounded">{t('chart_ph_danger')}</span>
            </div>
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-borderFlat p-5 md:p-6">
            <div className="flex items-center justify-between mb-8">
              <div className="flex items-center gap-2">
                ...
                <h3 className="text-lg font-bold text-textMain">{t('chart_humus_title')}</h3>
              </div>
              <span className="text-xs font-bold text-emerald-600 bg-emerald-50 px-2 py-1 rounded">{t('chart_humus_norm')}</span>
            </div>
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-borderFlat overflow-hidden">
          <div className="px-5 py-4 md:px-6 md:py-5 border-b border-borderFlat bg-gray-50">
            <h2 className="text-lg md:text-xl font-bold text-textMain">{t('table_real_title')}</h2>
            <p className="text-xs md:text-sm text-textMuted mt-1">{t('table_real_desc')}</p>
          </div>
            ...
            <table className="w-full text-left border-collapse min-w-[800px]">
              <thead>
                <tr className="bg-surface text-textMuted text-xs uppercase tracking-wider">
                  <th className="px-4 py-3 md:px-6 md:py-4 font-medium border-b border-borderFlat whitespace-nowrap">{t('th_location')}</th>
                  <th className="px-4 py-3 md:px-6 md:py-4 font-medium border-b border-borderFlat whitespace-nowrap">{t('th_depth')}</th>
                  <th className="px-4 py-3 md:px-6 md:py-4 font-medium border-b border-borderFlat whitespace-nowrap">pH</th>
                  <th className="px-4 py-3 md:px-6 md:py-4 font-medium border-b border-borderFlat whitespace-nowrap">{t('th_humus')}</th>
                  <th className="px-4 py-3 md:px-6 md:py-4 font-medium border-b border-borderFlat whitespace-nowrap">{t('th_nitrogen')}</th>
                  <th className="px-4 py-3 md:px-6 md:py-4 font-medium border-b border-borderFlat whitespace-nowrap">{t('th_phosphorus')}</th>
                  <th className="px-4 py-3 md:px-6 md:py-4 font-medium border-b border-borderFlat whitespace-nowrap">CO2 (%)</th>
                  <th className="px-4 py-3 md:px-6 md:py-4 font-medium border-b border-borderFlat whitespace-nowrap">{t('th_calcium')}</th>
                </tr>
              </thead>
