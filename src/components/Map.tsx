  ...
  return (
    <div className="relative w-full h-full">
      ...
      >
        ...
        {/* --- ПОДКЛЮЧЕННЫЕ СЛОИ (Точные имена файлов!) --- */}
        <GeoTiffLayer url="/layers/Sagyz_VCI_2025.tif" visible={showVCI} colorScale={colorScaleVCI} opacity={0.8} zIndex={106} />
        <GeoTiffLayer url="/layers/Sagyz_SAVI_2025.tif" visible={showSAVI} colorScale={colorScaleSAVI} opacity={0.8} zIndex={105} />
        <GeoTiffLayer url="/layers/Sagyz_NDVI_2025.tif" visible={showNDVI} colorScale={colorScaleNDVI} opacity={0.8} zIndex={104} />
        <GeoTiffLayer url="/layers/Makat_LULC_DW_2024.tif" visible={showLULC} colorScale={colorScaleLULC} opacity={0.7} zIndex={103} />
        <GeoTiffLayer url="/layers/Makat_Soil_pH.tif" visible={showPH} colorScale={colorScalePH} opacity={0.7} zIndex={102} />
        <GeoTiffLayer url="/layers/Makat_Soil_Texture.tif" visible={showTexture} colorScale={colorScaleTexture} opacity={0.7} zIndex={101} />
      </MapContainer>
